...
library api.src.smart_contract_method_argument;
...
class SmartContractMethodArgument implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("SmartContractMethodArgument");
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("SmartContractMethodArgument(");
