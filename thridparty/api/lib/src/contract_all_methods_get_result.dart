...
library api.src.contract_all_methods_get_result;
...
class ContractAllMethodsGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("ContractAllMethodsGetResult");
  ...
  static final TField _METHODS_FIELD_DESC = TField("methods", TType.LIST, 3);

  int _code = 0;
  static const int CODE = 1;
  String _message = "";
  static const int MESSAGE = 2;
  List<t_general.MethodDescription> _methods = [];
  ...
  // methods
  List<t_general.MethodDescription> get methods => this._methods;

  set methods(List<t_general.MethodDescription> methods) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i109 = 0; _i109 < _list108.length; ++_i109) {
                t_general.MethodDescription _elem110;//declare element for this.methods
                _elem110 = t_general.MethodDescription();
                _elem110.read(iprot);
                this.methods.add(_elem110);//add element to parent this.methods
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldBegin(_METHODS_FIELD_DESC);
    {
      ...
      for (var elem111 in this.methods) {
        elem111.write(oprot);
      }
      oprot.writeListEnd();
    }
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("ContractAllMethodsGetResult(");
