...
library api.src.transactions_state_get_result;
...
class TransactionsStateGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("TransactionsStateGetResult");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _STATES_FIELD_DESC = TField("states", TType.MAP, 2);
  ...
  Map<int, int> _states = Map<int, int>();
  ...
  // states
  Map<int, int> get states => this._states;

  set states(Map<int, int> states) {
    this._states = states;
  }
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_STATES_FIELD_DESC);
    {
      oprot.writeMapBegin(TMap(TType.I64, TType.I32, this.states.length));
      for (var elem103 in this.states.keys) {
        oprot.writeI64(elem103);
        oprot.writeI32(this.states[elem103]!);
      }
      oprot.writeMapEnd();
    }
    oprot.writeFieldEnd();
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("TransactionsStateGetResult(");
