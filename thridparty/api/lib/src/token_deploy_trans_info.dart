...
library api.src.token_deploy_trans_info;
...
class TokenDeployTransInfo implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("TokenDeployTransInfo");
  ...
  static final TField _STATE_FIELD_DESC = TField("state", TType.I32, 4);
  static final TField _STATE_TRANSACTION_FIELD_DESC = TField("stateTransaction", TType.STRUCT, 5);
  ...
  static const int STATETRANSACTION = 5;
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("TokenDeployTransInfo(");
