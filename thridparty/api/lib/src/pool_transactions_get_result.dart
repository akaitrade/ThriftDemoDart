...
library api.src.pool_transactions_get_result;
...
class PoolTransactionsGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("PoolTransactionsGetResult");
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i83 = 0; _i83 < _list82.length; ++_i83) {
                SealedTransaction _elem84;//declare element for this.transactions
                _elem84 = SealedTransaction();
                _elem84.read(iprot);
                this.transactions.add(_elem84);//add element to parent this.transactions
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldBegin(_TRANSACTIONS_FIELD_DESC);
    {
      ...
      for (var elem85 in this.transactions) {
        elem85.write(oprot);
      }
      oprot.writeListEnd();
    }
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("PoolTransactionsGetResult(");
