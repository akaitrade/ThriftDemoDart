...
class RoundData implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("RoundData");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _ROUND_NUM_FIELD_DESC = TField("roundNum", TType.I64, 2);
  static final TField _SUB_ROUND_FIELD_DESC = TField("subRound", TType.I32, 3);

  t_general.APIResponse _status = t_general.APIResponse();
  static const int STATUS = 1;
  int _roundNum = 0;
  static const int ROUNDNUM = 2;
  int _subRound = 0;
  static const int SUBROUND = 3;
  ...
  // subRound
  int get subRound => this._subRound;

  set subRound(int subRound) {
    this._subRound = subRound;
  }
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeI64(this.roundNum);
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_SUB_ROUND_FIELD_DESC);
    oprot.writeI32(this.subRound);
    oprot.writeFieldEnd();
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("RoundData(");
