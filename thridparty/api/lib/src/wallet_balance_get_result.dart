...
library api.src.wallet_balance_get_result;
...
class WalletBalanceGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("WalletBalanceGetResult");
  ...
  static final TField _DELEGATED_FIELD_DESC = TField("delegated", TType.STRUCT, 3);
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("WalletBalanceGetResult(");
