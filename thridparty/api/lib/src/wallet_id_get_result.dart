...
library api.src.wallet_id_get_result;
...
class WalletIdGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("WalletIdGetResult");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _WALLET_ID_FIELD_DESC = TField("walletId", TType.I32, 2);

  t_general.APIResponse _status = t_general.APIResponse();
  static const int STATUS = 1;
  int _walletId = 0;
  static const int WALLETID = 2;
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("WalletIdGetResult(");
