...
library api.src.wallet_data_get_result;
...
class WalletDataGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("WalletDataGetResult");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _WALLET_DATA_FIELD_DESC = TField("walletData", TType.STRUCT, 2);

  t_general.APIResponse _status = t_general.APIResponse();
  static const int STATUS = 1;
  WalletData _walletData = WalletData();
  static const int WALLETDATA = 2;
  ...
  set walletData(WalletData walletData) {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_WALLET_DATA_FIELD_DESC);
    this.walletData.write(oprot);
    oprot.writeFieldEnd();
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("WalletDataGetResult(");

    ret.write("status:");
    ret.write(this.status);

    ret.write(", ");
    ret.write("walletData:");
    ret.write(this.walletData);
