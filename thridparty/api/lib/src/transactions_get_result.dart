...
library api.src.transactions_get_result;
...
class TransactionsGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("TransactionsGetResult");
  ...
  static final TField _TOTAL_TRXNS_COUNT_FIELD_DESC = TField("total_trxns_count", TType.I32, 3);
  static final TField _TRANSACTIONS_FIELD_DESC = TField("transactions", TType.LIST, 4);

  t_general.APIResponse _status = t_general.APIResponse();
  static const int STATUS = 1;
  bool _result = false;
  static const int RESULT = 2;
  int _total_trxns_count = 0;
  static const int TOTAL_TRXNS_COUNT = 3;
  List<SealedTransaction> _transactions = [];
  static const int TRANSACTIONS = 4;
  ...
  // total_trxns_count
  int get total_trxns_count => this._total_trxns_count;

  set total_trxns_count(int total_trxns_count) {
    this._total_trxns_count = total_trxns_count;
  }

  // transactions
  List<SealedTransaction> get transactions => this._transactions;

  set transactions(List<SealedTransaction> transactions) {
  ...
  read(TProtocol iprot) {
    ...
    bool __isset_total_trxns_count = false;
      ...
      switch (field.id) {
        ...
        case TOTAL_TRXNS_COUNT:
          if (field.type == TType.I32) {
            this.total_trxns_count = iprot.readI32();
          } else {
            TProtocolUtil.skip(iprot, field.type);
          }
          break;
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.transactions = [];
              for (int _i47 = 0; _i47 < _list46.length; ++_i47) {
                SealedTransaction _elem48;//declare element for this.transactions
                _elem48 = SealedTransaction();
                _elem48.read(iprot);
                this.transactions.add(_elem48);//add element to parent this.transactions
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_TOTAL_TRXNS_COUNT_FIELD_DESC);
    oprot.writeI32(this.total_trxns_count);
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_TRANSACTIONS_FIELD_DESC);
    {
      oprot.writeListBegin(TList(TType.STRUCT, this.transactions.length));
      for (var elem49 in this.transactions) {
        elem49.write(oprot);
      }
      oprot.writeListEnd();
    }
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("TransactionsGetResult(");
    ...
    ret.write(", ");
    ret.write("total_trxns_count:");
    ret.write(this.total_trxns_count);
