...
library api.src.execute_count_get_result;
...
class ExecuteCountGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("ExecuteCountGetResult");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _EXECUTE_COUNT_FIELD_DESC = TField("executeCount", TType.I64, 2);

  t_general.APIResponse _status = t_general.APIResponse();
  static const int STATUS = 1;
  int _executeCount = 0;
  static const int EXECUTECOUNT = 2;


  ExecuteCountGetResult() {
  }
  ...
  // executeCount
  int get executeCount => this._executeCount;

  set executeCount(int executeCount) {
  ...
  read(TProtocol iprot) {
    ...
    bool __isset_executeCount = false;
    TField field;
      ...
      switch (field.id) {
        ...
        case EXECUTECOUNT:
          if (field.type == TType.I64) {
            this.executeCount = iprot.readI64();
          } else {
            TProtocolUtil.skip(iprot, field.type);
          }
          break;
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_EXECUTE_COUNT_FIELD_DESC);
    oprot.writeI64(this.executeCount);
    oprot.writeFieldEnd();
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("ExecuteCountGetResult(");

    ret.write("status:");
    ret.write(this.status);

    ret.write(", ");
    ret.write("executeCount:");
    ret.write(this.executeCount);
