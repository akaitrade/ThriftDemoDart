...
library api.src.smart_contract_method;
...
class SmartContractMethod implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("SmartContractMethod");
  ...
  List<SmartContractMethodArgument> _arguments = [];
  ...
  // arguments
  List<SmartContractMethodArgument> get arguments => this._arguments;

  set arguments(List<SmartContractMethodArgument> arguments) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i113 = 0; _i113 < _list112.length; ++_i113) {
                SmartContractMethodArgument _elem114;//declare element for this.arguments
                _elem114 = SmartContractMethodArgument();
                _elem114.read(iprot);
                this.arguments.add(_elem114);//add element to parent this.arguments
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldBegin(_ARGUMENTS_FIELD_DESC);
    {
      ...
      for (var elem115 in this.arguments) {
        elem115.write(oprot);
      }
      oprot.writeListEnd();
    }
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("SmartContractMethod(");
