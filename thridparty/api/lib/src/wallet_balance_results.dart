...
library api.src.wallet_balance_results;
...
class WalletBalanceResults implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("WalletBalanceResults");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _BALANCES_FIELD_DESC = TField("balances", TType.LIST, 2);

  t_general.APIResponse _status = t_general.APIResponse();
  static const int STATUS = 1;
  List<WalletBalanceFull> _balances = [];
  static const int BALANCES = 2;
  ...
  // balances
  List<WalletBalanceFull> get balances => this._balances;

  set balances(List<WalletBalanceFull> balances) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i187 = 0; _i187 < _list186.length; ++_i187) {
                WalletBalanceFull _elem188;//declare element for this.balances
                _elem188 = WalletBalanceFull();
                _elem188.read(iprot);
                this.balances.add(_elem188);//add element to parent this.balances
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_BALANCES_FIELD_DESC);
    {
      oprot.writeListBegin(TList(TType.STRUCT, this.balances.length));
      for (var elem189 in this.balances) {
        elem189.write(oprot);
      }
      oprot.writeListEnd();
    }
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("WalletBalanceResults(");
