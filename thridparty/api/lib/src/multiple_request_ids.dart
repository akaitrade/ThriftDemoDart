...
library api.src.multiple_request_ids;
...
class MultipleRequestIds implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("MultipleRequestIds");
  static final TField _IDS_FIELD_DESC = TField("ids", TType.LIST, 1);
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i179 = 0; _i179 < _list178.length; ++_i179) {
                int _elem180;//declare element for this.ids
                _elem180 = iprot.readI64();
                this.ids.add(_elem180);//add element to parent this.ids
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    {
      oprot.writeListBegin(TList(TType.I64, this.ids.length));
      for (var elem181 in this.ids) {
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("MultipleRequestIds(");
