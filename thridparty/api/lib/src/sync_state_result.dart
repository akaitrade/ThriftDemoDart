...
library api.src.sync_state_result;
...
class SyncStateResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("SyncStateResult");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _CURR_ROUND_FIELD_DESC = TField("currRound", TType.I64, 2);
  static final TField _LAST_BLOCK_FIELD_DESC = TField("lastBlock", TType.I64, 3);

  t_general.APIResponse _status = t_general.APIResponse();
  static const int STATUS = 1;
  int _currRound = 0;
  static const int CURRROUND = 2;
  int _lastBlock = 0;
  static const int LASTBLOCK = 3;
  ...
  // currRound
  int get currRound => this._currRound;

  set currRound(int currRound) {
    this._currRound = currRound;
  }

  // lastBlock
  int get lastBlock => this._lastBlock;

  set lastBlock(int lastBlock) {
  ...
  read(TProtocol iprot) {
    ...
    bool __isset_currRound = false;
    bool __isset_lastBlock = false;
    TField field;
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_CURR_ROUND_FIELD_DESC);
    oprot.writeI64(this.currRound);
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_LAST_BLOCK_FIELD_DESC);
    oprot.writeI64(this.lastBlock);
    oprot.writeFieldEnd();
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("SyncStateResult(");
    ...
    ret.write(", ");
    ret.write("currRound:");
    ret.write(this.currRound);

    ret.write(", ");
    ret.write("lastBlock:");
    ret.write(this.lastBlock);
