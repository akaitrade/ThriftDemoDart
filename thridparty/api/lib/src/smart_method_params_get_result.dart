...
library api.src.smart_method_params_get_result;
...
class SmartMethodParamsGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("SmartMethodParamsGetResult");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _METHOD_FIELD_DESC = TField("method", TType.STRING, 2);
  static final TField _PARAMS_FIELD_DESC = TField("params", TType.LIST, 3);
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i105 = 0; _i105 < _list104.length; ++_i105) {
                t_general.Variant _elem106;//declare element for this.params
                _elem106 = t_general.Variant();
                _elem106.read(iprot);
                this.params.add(_elem106);//add element to parent this.params
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldBegin(_PARAMS_FIELD_DESC);
    {
      ...
      for (var elem107 in this.params) {
        elem107.write(oprot);
      }
      oprot.writeListEnd();
    }
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("SmartMethodParamsGetResult(");
