...
library api.src.transactions_query;
...
class TransactionsQuery implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("TransactionsQuery");
  static final TField _FLAG_FIELD_DESC = TField("flag", TType.I16, 1);
  static final TField _QUERIES_FIELD_DESC = TField("queries", TType.LIST, 2);

  int _flag = 0;
  static const int FLAG = 1;
  List<SingleQuery> _queries = [];
  static const int QUERIES = 2;
  ...
  // queries
  List<SingleQuery> get queries => this._queries;

  set queries(List<SingleQuery> queries) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.queries = [];
              for (int _i59 = 0; _i59 < _list58.length; ++_i59) {
                SingleQuery _elem60;//declare element for this.queries
                _elem60 = SingleQuery();
                _elem60.read(iprot);
                this.queries.add(_elem60);//add element to parent this.queries
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    {
      oprot.writeListBegin(TList(TType.STRUCT, this.queries.length));
      for (var elem61 in this.queries) {
        elem61.write(oprot);
      }
      oprot.writeListEnd();
    }
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("TransactionsQuery(");
