...
library api.src.wallet_balance_full;
...
class WalletBalanceFull implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("WalletBalanceFull");
  static final TField _ADDRESSES_FIELD_DESC = TField("addresses", TType.STRING, 1);
  static final TField _NOT_FOUND_FIELD_DESC = TField("notFound", TType.BOOL, 2);
  static final TField _BALANCE_FIELD_DESC = TField("balance", TType.STRUCT, 3);
  static final TField _DELEGATED_FIELD_DESC = TField("delegated", TType.STRUCT, 4);

  Uint8List _addresses = Uint8List(0);
  ...
  // addresses
  Uint8List get addresses => this._addresses;

  set addresses(Uint8List addresses) {
    this._addresses = addresses;
  }

  // notFound
  bool get notFound => this._notFound;

  set notFound(bool notFound) {
      ...
      switch (field.id) {
        case ADDRESSES:
          if (field.type == TType.STRING) {
            this.addresses = iprot.readBinary();
          } else {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeBinary(this.addresses);
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_NOT_FOUND_FIELD_DESC);
    oprot.writeBool(this.notFound);
    oprot.writeFieldEnd();
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("WalletBalanceFull(");
