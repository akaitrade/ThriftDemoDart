...
library api.src.transaction_id;
...
class TransactionId implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("TransactionId");
  static final TField _POOL_SEQ_FIELD_DESC = TField("poolSeq", TType.I64, 1);
  static final TField _INDEX_FIELD_DESC = TField("index", TType.I32, 2);

  int _poolSeq = 0;
  static const int POOLSEQ = 1;
  int _index = 0;
  ...
  // poolSeq
  int get poolSeq => this._poolSeq;

  set poolSeq(int poolSeq) {
    this._poolSeq = poolSeq;
  }
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldBegin(_POOL_SEQ_FIELD_DESC);
    oprot.writeI64(this.poolSeq);
    oprot.writeFieldEnd();
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("TransactionId(");

    ret.write("poolSeq:");
    ret.write(this.poolSeq);
