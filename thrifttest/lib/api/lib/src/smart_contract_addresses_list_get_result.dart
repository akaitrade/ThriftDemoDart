...
library api.src.smart_contract_addresses_list_get_result;
...
class SmartContractAddressesListGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("SmartContractAddressesListGetResult");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _ADDRESSES_LIST_FIELD_DESC = TField("addressesList", TType.LIST, 2);

  t_general.APIResponse _status = t_general.APIResponse();
  static const int STATUS = 1;
  List<Uint8List> _addressesList = [];
  static const int ADDRESSESLIST = 2;
  ...
  // addressesList
  List<Uint8List> get addressesList => this._addressesList;

  set addressesList(List<Uint8List> addressesList) {
  ...
  read(TProtocol iprot) {
    ...
    bool __isset_addressesList = false;
    TField field;
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i91 = 0; _i91 < _list90.length; ++_i91) {
                Uint8List _elem92;//declare element for this.addressesList
                _elem92 = iprot.readBinary();
                this.addressesList.add(_elem92);//add element to parent this.addressesList
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_ADDRESSES_LIST_FIELD_DESC);
    {
      oprot.writeListBegin(TList(TType.STRING, this.addressesList.length));
      for (var elem93 in this.addressesList) {
        oprot.writeBinary(elem93);
      }
      oprot.writeListEnd();
    }
    oprot.writeFieldEnd();
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("SmartContractAddressesListGetResult(");

    ret.write("status:");
    ret.write(this.status);

    ret.write(", ");
    ret.write("addressesList:");
    ret.write(this.addressesList);
