...
library api.src.wallet_balance;
...
class WalletBalance implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("WalletBalance");
  static final TField _BALANCE_FIELD_DESC = TField("balance", TType.STRUCT, 1);
  static final TField _DELEGATED_FIELD_DESC = TField("delegated", TType.STRUCT, 2);

  t_general.Amount _balance = t_general.Amount();
  static const int BALANCE = 1;
  Delegated? _delegated;
  static const int DELEGATED = 2;
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("WalletBalance(");
