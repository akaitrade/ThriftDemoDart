...
library api.src.accepted_request_id;
...
class AcceptedRequestId implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("AcceptedRequestId");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _IDS_FIELD_DESC = TField("ids", TType.I64, 2);
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("AcceptedRequestId(");
