...
library api.src.token_holders_result;
...
class TokenHoldersResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("TokenHoldersResult");
  ...
  static final TField _HOLDERS_FIELD_DESC = TField("holders", TType.LIST, 3);
  ...
  // holders
  List<TokenHolder> get holders => this._holders;

  set holders(List<TokenHolder> holders) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i155 = 0; _i155 < _list154.length; ++_i155) {
                TokenHolder _elem156;//declare element for this.holders
                _elem156 = TokenHolder();
                _elem156.read(iprot);
                this.holders.add(_elem156);//add element to parent this.holders
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_HOLDERS_FIELD_DESC);
    {
      oprot.writeListBegin(TList(TType.STRUCT, this.holders.length));
      for (var elem157 in this.holders) {
        elem157.write(oprot);
      }
      oprot.writeListEnd();
    }
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("TokenHoldersResult(");
