...
library api.src.token_info_result;
...
class TokenInfoResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("TokenInfoResult");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _TOKEN_FIELD_DESC = TField("token", TType.STRUCT, 2);
  ...
  // token
  TokenInfo get token => this._token;

  set token(TokenInfo token) {
    this._token = token;
  }
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("TokenInfoResult(");
