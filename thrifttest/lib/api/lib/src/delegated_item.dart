...
library api.src.delegated_item;
...
class DelegatedItem implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("DelegatedItem");
  static final TField _WALLET_FIELD_DESC = TField("wallet", TType.STRING, 1);
  static final TField _SUM_FIELD_DESC = TField("sum", TType.STRUCT, 2);
  static final TField _VALID_UNTIL_FIELD_DESC = TField("validUntil", TType.I64, 3);

  Uint8List _wallet = Uint8List(0);
  static const int WALLET = 1;
  t_general.Amount _sum = t_general.Amount();
  static const int SUM = 2;
  int? _validUntil;
  static const int VALIDUNTIL = 3;
  ...
  // wallet
  Uint8List get wallet => this._wallet;

  set wallet(Uint8List wallet) {
    this._wallet = wallet;
  }
  ...
  bool isSetValidUntil() => this.validUntil != null;
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldBegin(_WALLET_FIELD_DESC);
    oprot.writeBinary(this.wallet);
    oprot.writeFieldEnd();
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("DelegatedItem(");

    ret.write("wallet:");
    ret.write(this.wallet);
