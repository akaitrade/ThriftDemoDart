...
library api.src.pool_info_get_result;
...
class PoolInfoGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("PoolInfoGetResult");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _IS_FOUND_FIELD_DESC = TField("isFound", TType.BOOL, 2);
  static final TField _POOL_FIELD_DESC = TField("pool", TType.STRUCT, 3);

  t_general.APIResponse _status = t_general.APIResponse();
  static const int STATUS = 1;
  bool _isFound = false;
  static const int ISFOUND = 2;
  Pool _pool = Pool();
  ...
  set isFound(bool isFound) {
    this._isFound = isFound;
  }

  // pool
  Pool get pool => this._pool;
  ...
  read(TProtocol iprot) {
    ...
    bool __isset_isFound = false;
    bool __isset_pool = false;
    TField field;
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_IS_FOUND_FIELD_DESC);
    oprot.writeBool(this.isFound);
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_POOL_FIELD_DESC);
    this.pool.write(oprot);
    oprot.writeFieldEnd();
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("PoolInfoGetResult(");
