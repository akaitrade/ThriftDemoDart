...
library api.src.token_transactions_result;
...
class TokenTransactionsResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("TokenTransactionsResult");
  ...
  static final TField _TRANSACTIONS_FIELD_DESC = TField("transactions", TType.LIST, 3);
  ...
  // transactions
  List<TokenTransaction> get transactions => this._transactions;

  set transactions(List<TokenTransaction> transactions) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i151 = 0; _i151 < _list150.length; ++_i151) {
                TokenTransaction _elem152;//declare element for this.transactions
                _elem152 = TokenTransaction();
                _elem152.read(iprot);
                this.transactions.add(_elem152);//add element to parent this.transactions
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldBegin(_TRANSACTIONS_FIELD_DESC);
    {
      ...
      for (var elem153 in this.transactions) {
        elem153.write(oprot);
      }
      oprot.writeListEnd();
    }
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("TokenTransactionsResult(");
