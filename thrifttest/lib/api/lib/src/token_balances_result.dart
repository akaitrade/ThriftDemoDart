...
library api.src.token_balances_result;
...
class TokenBalancesResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("TokenBalancesResult");
  ...
  // balances
  List<TokenBalance> get balances => this._balances;

  set balances(List<TokenBalance> balances) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i139 = 0; _i139 < _list138.length; ++_i139) {
                TokenBalance _elem140;//declare element for this.balances
                _elem140 = TokenBalance();
                _elem140.read(iprot);
                this.balances.add(_elem140);//add element to parent this.balances
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldBegin(_BALANCES_FIELD_DESC);
    {
      ...
      for (var elem141 in this.balances) {
        elem141.write(oprot);
      }
      oprot.writeListEnd();
    }
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("TokenBalancesResult(");
