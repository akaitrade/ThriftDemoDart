...
library api.src.wallets_get_result;
...
class WalletsGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("WalletsGetResult");
  ...
  static final TField _WALLETS_FIELD_DESC = TField("wallets", TType.LIST, 3);
  ...
  // wallets
  List<WalletInfo> get wallets => this._wallets;
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i163 = 0; _i163 < _list162.length; ++_i163) {
                WalletInfo _elem164;//declare element for this.wallets
                _elem164 = WalletInfo();
                _elem164.read(iprot);
                this.wallets.add(_elem164);//add element to parent this.wallets
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_WALLETS_FIELD_DESC);
    {
      oprot.writeListBegin(TList(TType.STRUCT, this.wallets.length));
      for (var elem165 in this.wallets) {
        elem165.write(oprot);
      }
      oprot.writeListEnd();
    }
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("WalletsGetResult(");
