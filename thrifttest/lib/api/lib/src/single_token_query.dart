...
library api.src.single_token_query;
...
class SingleTokenQuery implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("SingleTokenQuery");
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("SingleTokenQuery(");
