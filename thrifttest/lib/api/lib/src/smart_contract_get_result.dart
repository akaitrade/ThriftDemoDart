...
library api.src.smart_contract_get_result;
...
class SmartContractGetResult implements TBase {
  static final TStruct _STRUCT_DESC = TStruct("SmartContractGetResult");
  static final TField _STATUS_FIELD_DESC = TField("status", TType.STRUCT, 1);
  static final TField _SMART_CONTRACT_FIELD_DESC = TField("smartContract", TType.STRUCT, 2);

  t_general.APIResponse _status = t_general.APIResponse();
  static const int STATUS = 1;
  SmartContract _smartContract = SmartContract();
  static const int SMARTCONTRACT = 2;
  ...
  // smartContract
  SmartContract get smartContract => this._smartContract;

  set smartContract(SmartContract smartContract) {
  ...
  @override
  String toString() {
    StringBuffer ret = StringBuffer("SmartContractGetResult(");
